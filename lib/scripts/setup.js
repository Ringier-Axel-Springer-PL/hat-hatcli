            ...
            const options = await prompts([
                {
                    ...
                    name: 'WEBSITE_DOMAIN',
                    message: 'Domain',
                    initial: profile ? this.loadedConfig.profiles[profile]?.WEBSITE_DOMAIN || null : null
                }, {
                    type: 'text',
                    ...
                    initial: profile ? this.loadedConfig.profiles[profile]?.WEBSITE_API_VARIANT || null : null
                }, {
                    type: 'text',
                    name: 'OCDN_BUCKET_NAME',
                    message: 'OCDN bucket name',
                    initial: profile ? this.loadedConfig.profiles[profile]?.OCDN_BUCKET_NAME || null : null
                }, {
                    type: 'text',
                    name: 'OCDN_TRANSFORM_KEY',
                    message: 'OCDN transform key',
                    initial: profile ? this.loadedConfig.profiles[profile]?.OCDN_TRANSFORM_KEY || null : null
                }], { onCancel: () => {userExited = true} });

            if (!userExited) {
                this.loadedConfig.profiles[options.profileName] = {
                    "WEBSITE_DOMAIN": options.WEBSITE_DOMAIN,
                    ...
                    "OCDN_BUCKET_NAME": options.OCDN_BUCKET_NAME,
                    "OCDN_TRANSFORM_KEY": options.OCDN_TRANSFORM_KEY,
                }
